...
class gui(tk.Frame):
    def __init__(self, parent):
        ...
        parent.configure(background = '#011627')
        ...
        self.canvas.create_text(150,30,font='Times 40 bold',text='User', fill='black')
        self.canvas.create_text(450,30,font='Times 40 bold',text='PC', fill='black')
